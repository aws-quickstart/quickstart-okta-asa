...
To use this Quick Start, you must be an Okta Org administrator. If you don't already have an Okta account, https://www.okta.com/free-trial[sign up for a free trial^]. Okta Advanced Server Access is an integrated application with an existing Okta Org. To create an Advanced Server Access team, visit the https://app.scaleft.com/p/signup[sign-up page^], and follow the instructions.